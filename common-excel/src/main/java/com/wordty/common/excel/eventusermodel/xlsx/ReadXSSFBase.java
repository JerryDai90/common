package com.wordty.common.excel.eventusermodel.xlsx;


import com.wordty.common.excel.eventusermodel.xlsx.exception.XlsContentImproperException;
import com.wordty.common.excel.eventusermodel.xlsx.extern.SimpleCell;
import com.wordty.common.excel.eventusermodel.xlsx.extern.SimpleRow;
import com.wordty.common.excel.eventusermodel.xlsx.handler.WorkbookXMLTable;
import com.wordty.common.excel.eventusermodel.xlsx.handler.XSSFSheetXMLHandler;
...
import com.wordty.common.excel.eventusermodel.xlsx.handler.XSSFSheetXMLHandler.SheetContentsHandler;
import com.wordty.common.excel.eventusermodel.xlsx.handler.XSSFSheetXMLHandler.xssfDataType;

import java.util.*;

public class ReadXSSFBase implements SheetContentsHandler {
	...
	public ReadXSSFBase(String path, String sheetName)
	{
		this.filePath = path;
		this.sheetName = sheetName;
	}
	public void setStencilTitle(List<String> stencilTitle) {this.stencilTitle = stencilTitle; }
	public List<SimpleRow> getWorkbookMap(){ return workbookMap; }
	public XlsContentImproperException getImproperException(){return improperException;}
	public int getValidRowSum() { return validRowSum; }
	...
	protected void initTitle(){
		...
		if( null == stencilTitle || stencilTitle.isEmpty() ){
			throw new NullPointerException("未输入保存在数据库中的模板列头");
		}
		...
		if( title.containsAll(stencilTitle) ){
			...
			throw new NullPointerException("在上传的excel中未找到title："+stencilTitle.toString());
		}
	}
	...
	public void endRow(int rowNum)
	{
		...
		if( rowNum != 0 && title.isEmpty() ){
			throw new RuntimeException("未在上传的excel中的首行找到列头");
		}
		//处理表头
		if( 0 == rowNum ){
			initTitle();
	 ...
	 */
	@Override
	public void cell(String cellReference, String cellValue, String formattedValue, xssfDataType nextDataType, String formatString, int rowNum)
	{
		if( 0 == rowNum ){
	...
	{
		//LKA Raw Data Format
		ReadXSSFBase t = new ReadXSSFBase("/Users/jerry/Mix/共享/test.xlsx", "1");
//		String title = "";

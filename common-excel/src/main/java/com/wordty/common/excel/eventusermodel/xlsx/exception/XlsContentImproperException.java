package com.wordty.common.excel.eventusermodel.xlsx.exception;
...
public class XlsContentImproperException implements java.io.Serializable
{
	...
	public Collection<Entry> getErrors(){return errors;}
	public void setFileName(String fileName){this.fileName = fileName;}
	public void setSheetName(String sheetName){this.sheetName = sheetName;}
	public void setErrors(Collection<Entry> errors){this.errors = errors;}
	...
	public static class Entry
	{
		...
		public Map<String, String> getHmData(){return hmData;}
		public Map<String, String> getOtherError(){return otherError;}
		public void setOtherError(Map<String, String> otherError){this.otherError = otherError;}

package com.wordty.common.excel.eventusermodel.xlsx.db;
...
import com.wordty.common.excel.eventusermodel.xlsx.ReadXSSFBase;
import com.wordty.common.excel.eventusermodel.xlsx.db.vo.DBFieldType;
 ...
 * 读取 excel 直接写入数据
 */
public class XSSF2DB extends ReadXSSFBase
{
	static Logger logger = Logger.getLogger(XSSF2DB.class);
...
//				String format = cell.getFormatString();
	...
	public void setDbFieldTypes(List<DBFieldType> dbFieldTypes){this.dbFieldTypes = dbFieldTypes;}
	public void setConnection(Connection conn){this.conn = conn;}
	public void setInsertRowNum(boolean insertRowNum){this.insertRowNum = insertRowNum;}
	public void setRowColumnName(String rowColumnName){this.rowColumnName = rowColumnName;}
	public int getValidInsertRowSum(){return validInsertRowSum;}
